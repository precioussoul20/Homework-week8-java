...
public class Programme13_SharedDigit {
    ...
    public static boolean hasSharedDigit(int number1, int number2) {
        if ((number1 < 10 || number1 > 99) || (number2 < 10 || number2 > 99)) {
            return false; // check if numbers are within the specified range
        }
        int digit1 = number1 % 10;
        int digit2 = number2 % 10;
        int tensDigit1 = number1 / 10;
        int tensDigit2 = number2 / 10;

        return (digit1 == digit2 || digit1 == tensDigit2 || tensDigit1 == digit2 || tensDigit1 == tensDigit2);
    }
}